...
下面这支展示同一组课堂批注，对比原生 Manim 的规整几何和 `manim-stroke` 的自然笔触：
手写文字、下划线、删除线、圈选、高亮和常用手势。
...
用 `hanzi()` 在宣纸米黄底上逐笔写出李白《月下独酌》：标题、作者、诗句横排，右下朱红落印。

<video controls width="720" src="https://github.com/user-attachments/assets/d37faa80-b546-439b-9558-9884bfe0a3c0"></video>

如果当前页面不直接播放，也可以[打开中文手写视频](https://github.com/user-attachments/assets/d37faa80-b546-439b-9558-9884bfe0a3c0)。
